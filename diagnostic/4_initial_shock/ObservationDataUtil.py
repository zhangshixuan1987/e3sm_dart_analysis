...
class ObsDataReader:
    ...
    def _define_obs_group(self):
        return {
            ...
            'NOAA_IOLR': {
                'monthly': {
                    'path': '/global/cfs/cdirs/m4849/zhan391/e3sm_dart/Observations/NOAA_IOLR/monthly',
                    'template': 'FLUT.monthly.%(year)s.nc',
                    'period': '2010-2015'
                },
                'daily': {
                    'path': '/global/cfs/cdirs/m4849/zhan391/e3sm_dart/Observations/NOAA_IOLR/daily',
                    'template': 'FLUT.daily.%(year)s.nc',
                    'period': '2010-2015'
                }
            },
            'GPCP': {
