...
class ObsDataReader:
    ...
    def _define_obs_group(self):
        return {
            'ERA5': {
                'monthly': {
                    'path': '/pscratch/sd/z/zhan391/e3sm_dart/Observations/ERA5/monthly',
                    'template': 'ERA5_analysis_monthly_%(year)s.nc',
                    'period': '2001-2018'
                },
                '6hourly': {
                    'path': '/pscratch/sd/z/zhan391/e3sm_dart/Observations/ERA5/6hourly',
            ...
            'NOAA_IOLR': {
                'monthly': {
                    'path': '/pscratch/sd/z/zhan391/e3sm_dart/Observations/NOAA_IOLR/monthly',
                    'template': 'PRECT.monthly.%(year)s.nc',
                    'period': '2010-2015'
                },
                'daily': {
                    'path': '/pscratch/sd/z/zhan391/e3sm_dart/Observations/NOAA_IOLR/daily',
            ...
            'GPCP': {
                'monthly': {
                    'path': '/pscratch/sd/z/zhan391/e3sm_dart/Observations/GPCP/monthly',
                    'template': 'PRECT.monthly.%(year)s.nc',
                    'period': '2010-2015'
                },
                'daily': {
                    'path': '/pscratch/sd/z/zhan391/e3sm_dart/Observations/GPCP/daily',
                    'template': 'PRECT.daily.%(year)s.nc',
                    'period': '2010-2015'
                }
            },
            'IMERG': {
                'daily': {
                    'path': '/pscratch/sd/z/zhan391/e3sm_dart/Observations/IMERG/daily',
                    'template': 'PRECT.daily.%(year)s.nc',
                    'period': '2007-2011'
                },
                'monthly': {
                    'path': '/pscratch/sd/z/zhan391/e3sm_dart/Observations/IMERG/monthly',
                    'template': 'PRECT.daily.%(year)s.nc',
                    'period': '2007-2011'
                }
            },
            'CERES-OAFlux': {
                'monthly': {
                    'path': '/pscratch/sd/z/zhan391/e3sm_dart/Observations/CERES-OAFlux/monthly',
            ...
            'ESA_CCI': {
                ...
                'monthly': {
                    'path': '/pscratch/sd/z/zhan391/e3sm_dart/Observations/ESA_CCI/monthly',
                    'template': 'H2OSOI.monthly.%(year)s.nc',
                    'period': '2001-2020'
                }
            },
            'MODIS_LST': {
                'monthly': {
                    'path': '/pscratch/sd/z/zhan391/e3sm_dart/Observations/MODIS_LST/monthly',
