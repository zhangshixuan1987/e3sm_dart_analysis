...
readonly RESOLUTION="SGP_ne32x8pg2"
readonly CASE_NAME="v2.SGP.ne256.dt200.F2010.p30"
...
readonly OLD_EXECUTABLE="/qfs/people/zhan524/cshr/e3sm_scratch/v2.SGP.ne256.F2010.p30/build/e3sm.exe"
...
ncdata         = '/compyfs/liji711/RRM_IC_generation/SGP_ne32x8_eamini_adjust_ps.nc'
inithist = 'MONTHLY'
inithist_all = .true.
mfilt   = 1,1
nhtfrq  = 0,-24
...
runtime_options() {
    ...
    # set time step dtime=86400/ATM_NCPL
    ./xmlchange ATM_NCPL=432
